package edu.campusvirtual.comunica.decorators
...
class StickyHeaderItem(recyclerView: RecyclerView, private val mListener: StickyHeaderInterface) : RecyclerView.ItemDecoration() {
